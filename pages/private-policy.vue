<template>
  <section class="section">
    <div class="container">
      <p class="has-text-centered subtitle">개인정보처리방침</p>
      <div>
        <p class="ls2 lh6 bs5 ts4">
          <em class="emphasis"> ('BAZZI.GG'이하 'BAZZI.GG') </em>
          은(는) 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고
          개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과
          같은 처리방침을 두고 있습니다.
        </p>
        <p class="ls2 lh6 bs5 ts4">
          <em class="emphasis"> ('BAZZI.GG') </em>
          은(는) 회사는 개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는
          개별공지)을 통하여 공지할 것입니다.
        </p>
        <p class="ls2">
          ○ 본 방침은부터 <em class="emphasis">2020</em>년
          <em class="emphasis">12</em>월 <em class="emphasis">1</em>일부터
          시행됩니다.
        </p>
        <br />
        <p class="lh6 bs4">
        ...
        <br /><br />
        <p class="lh6 bs4">
          <strong>3. 개인정보의 처리 및 보유 기간</strong><br /><br />①
          <em class="emphasis"> ('BAZZI.GG') </em>
          은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
          개인정보를 수집시에 동의 받은 개인정보 보유,이용기간 내에서 개인정보를
          처리,보유합니다.<br /><br />② 각각의 개인정보 처리 및 보유 기간은
          다음과 같습니다.
        </p>
        <ul class="list_indent2 mgt10">
          ...
          <li class="tt">
            ...
            동의일로부터 &lt;영구> 까지 위 이용목적을 위하여 보유.이용됩니다.
          </li>
          <li>보유근거 : 과거 민원 이력 조회를 위해</li>
          <li>관련법령 :</li>
          <li>예외사유 :</li>
        </ul>
        <p class="lh6 bs4">
        ...
        <p class="ls2">
          ① 정보주체는 Plorence에 대해 언제든지 개인정보 열람,정정,삭제,처리정지
          요구 등의 권리를 행사할 수 있습니다.
        </p>
        <p class="sub_p">
          ② 제1항에 따른 권리 행사는Plorence에 대해 개인정보 보호법 시행령
          제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
          있으며 Plorence은(는) 이에 대해 지체 없이 조치하겠습니다.
        </p>
        <p class="sub_p">
        ...
        <p class="sub_p">
          ⑥ Plorence은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
        ...
        <p class="ls2">
          ...
          법률에 의한 경우가 아니고서는 다른 목적으로 이용되지 않습니다.<br /><br />-파기기한<br />이용자의
        ...
        <p class="lh6 bs4">
          <strong
            >7. 개인정보 자동 수집 장치의 설치•운영 및 거부에 관한 사항</strong
          >
        </p>
        <p class="ls2">
          ① Plorence 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고
        ...
        <p class="sub_p mgt10">
          ①
          <span class="colorLightBlue">Plorence(‘BAZZI.GG’이하 ‘BAZZI.GG)</span>
        ...
        <p class="sub_p">
          ② 정보주체께서는 Plorence(‘BAZZI.GG’이하 ‘BAZZI.GG) 의 서비스(또는
          사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리,
          피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실
          수 있습니다. Plorence(‘BAZZI.GG’이하 ‘BAZZI.GG) 은(는) 정보주체의
